...
export { default as ledger } from './wallets-logos/ledger.svg';
...
export { default as visibilityOn } from './static/visibility-on.svg';
export { default as visibilityOff } from './static/visibility-off.svg';
